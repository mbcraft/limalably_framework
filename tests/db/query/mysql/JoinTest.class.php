...
class JoinTest extends LTestCase {
	...
	function testLeftJoin() {
		...
		$lj1 = LMysqlGenericJoin::left_join('table_123',LMysqlCondition::equal('field_name',12));
		$lj2 = LMysqlGenericJoin::left_join('table_123',new LMysqlAndBlock(LMysqlCondition::equal('field_name1',12),LMysqlCondition::not_equal('field_name2','ab')));
		$lj3 = LMysqlGenericJoin::left_join('table_123',new LMysqlOrBlock(LMysqlCondition::equal('field_name1',12),LMysqlCondition::not_equal('field_name2','ab')));
		$lj4 = LMysqlGenericJoin::left_join('table_123',[LMysqlCondition::equal('field_name1',12),LMysqlCondition::not_equal('field_name2','ab')]);
	...
	function testRightJoin() {
		...
		$rj1 = LMysqlGenericJoin::right_join('table_123',LMysqlCondition::equal('field_name',12));
		$rj2 = LMysqlGenericJoin::right_join('table_123',new LMysqlAndBlock(LMysqlCondition::equal('field_name1',12),LMysqlCondition::not_equal('field_name2','ab')));
		$rj3 = LMysqlGenericJoin::right_join('table_123',new LMysqlOrBlock(LMysqlCondition::equal('field_name1',12),LMysqlCondition::not_equal('field_name2','ab')));
		$rj4 = LMysqlGenericJoin::right_join('table_123',[LMysqlCondition::equal('field_name1',12),LMysqlCondition::not_equal('field_name2','ab')]);
	...
	function testCrossJoin() {
		...
		$cj1 = LMysqlGenericJoin::cross_join('table_123',LMysqlCondition::equal('field_name',12));
		$cj2 = LMysqlGenericJoin::cross_join('table_123',new LMysqlAndBlock(LMysqlCondition::equal('field_name1',12),LMysqlCondition::not_equal('field_name2','ab')));
		$cj3 = LMysqlGenericJoin::cross_join('table_123',new LMysqlOrBlock(LMysqlCondition::equal('field_name1',12),LMysqlCondition::not_equal('field_name2','ab')));
		$cj4 = LMysqlGenericJoin::cross_join('table_123',[LMysqlCondition::equal('field_name1',12),LMysqlCondition::not_equal('field_name2','ab')]);
